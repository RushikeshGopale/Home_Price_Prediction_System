...
function interested(pid)
{
	...
	xhttp.open("GET","/HousePriceWebApplication/InterestedProperty?pid="+pid,true);
	xhttp.send();
}
...
function predictPrice()
{
	...
	xhttp.open("GET","/HousePriceWebApplication/PredictPriceServlet?lid="+lid+"&sqfeet="+sqfeet,true);
	xhttp.send();
}
